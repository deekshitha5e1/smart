...
import { 
  ...
  ChevronRight, Calendar, AlertCircle, CheckCircle, Clock, X, Info, Download, Printer
} from 'lucide-react';
            ...
            {filteredPrescriptions.map(presc => {
              ...
              return (
                ...
                >
                  ...
                  <div className="no-print" style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem', marginBottom: '0.5rem' }}>
                    <button
